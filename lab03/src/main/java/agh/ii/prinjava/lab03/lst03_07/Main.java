...
public class Main {
    ...
    private static final String counterFileName = "counter.txt";

    private static int readExecutionCounter() {
        int counter = 0;
    ...
    private static void writeExecutionCounter(int counter) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(counterFileName))) {
    ...
    private static void updateAndDisplayExecutionCounter() {
        int counter = readExecutionCounter() + 1;
        writeExecutionCounter(counter);
        System.out.println("This program has been executed " + counter + " times.");
    }


    public static void main(String[] args) {
        updateAndDisplayExecutionCounter();
