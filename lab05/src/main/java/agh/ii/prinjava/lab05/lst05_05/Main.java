...
public class Main {
    ...
    public static TreeSet<String> toUpperCaseTreeSet(TreeSet<String> inputSet) {
    ...
    private static void demo_Lab(){
        TreeSet<String> originalSet = new TreeSet<>();
        originalSet.add("stringOne");
        originalSet.add("stringTwo");
        originalSet.add("stringThree");

        TreeSet<String> upperCaseSet = toUpperCaseTreeSet(originalSet);
